...
class ASRGenerator(object):
    ...
    async def load_audiofile(self, audio_path: str) -> torch.Tensor:
        """
    ...
    async def transcribe_audiofile(self, audio_path: str, lower=True) -> str:
        """
        ...
        asr_input = await self.load_audiofile(audio_path)
